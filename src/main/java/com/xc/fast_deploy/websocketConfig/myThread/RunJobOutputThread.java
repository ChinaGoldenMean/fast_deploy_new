...
public class RunJobOutputThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            b = moduleJobService.runJob(jobDataVo.getJobId(), session,
                jobDataVo.getToken(),
                jobDataVo.getIsUpdateAllCode(), jobDataVo.getIsNeedUpCode(), jobDataVo.getIsPromptly(), jobDataVo.getNeedIdStr(), jobDataVo.getIsOffline());
        } catch (Exception e) {
