...
//        }
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public boolean runJob(Integer jobId, Session session,
                          String token, boolean isUpdateAllCode,
                          boolean isNeedUpCode, Boolean isPromptly, String needIdStr, Boolean isOffline) throws Exception {
